...
cejst.nw <- read_sf("C:/Users/carolynkoehn/Documents/HES505_Fall_2024/data/2023/assignment04/cejst_nw.shp")
all(st_is_valid(cejst.nw))
any(st_is_empty(cejst.nw))
which(st_is_empty(cejst.nw))
...
hospitals.id <- read_csv("C:/Users/carolynkoehn/Documents/HES505_Fall_2024/data/2023/assignment04/landmarks_ID.csv") %>% 
  st_as_sf(., coords = c("longitude", "lattitude")) %>% 
  filter(., MTFCC == "K1231")
st_crs(hospitals.id) <- 4326
