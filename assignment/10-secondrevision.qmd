...
2. What are your strategies for checking that an operation resulted in the output you expected? How do you identify syntax errors and semantic errors (see [session 6](https://isdrfall24.classes.spaseslab.com/content/06-content.html) for definitions) in your work?
