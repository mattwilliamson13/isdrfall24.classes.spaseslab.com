...
cdc.nw <- read_sf("C:/Users/carolynkoehn/Documents/HES505_Fall_2024/data/2023/assignment03/cdc_nw.shp")
str(cdc.nw)
all(st_is_valid(cdc.nw))
pm.nw <- read_sf("C:/Users/carolynkoehn/Documents/HES505_Fall_2024/data/2023/assignment03/pm_nw.shp")
str(pm.nw)
all(st_is_valid(pm.nw))

wildfire.haz <- rast("C:/Users/carolynkoehn/Documents/HES505_Fall_2024/data/2023/assignment03/wildfire_hazard_agg.tif")
str(wildfire.haz)
```
